...
`kustomize edit set image ghcr.io/charliesu/unifand:v0.6.4` in your overlay, <!-- x-release-please-version -->
...
spec:
  ...
  ref:
    ...
    semver: ">=0.6.4" # x-release-please-version
---
...
spec:
  ...
  images:
    - name: ghcr.io/charliesu/unifand
      newTag: v0.6.4 # x-release-please-version
  prune: true
```
